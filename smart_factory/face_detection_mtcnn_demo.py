...
sys.path.append('/home/ssk/ssk/intel_mark2/class02/smart-factory')
sys.path.append('/home/ssk/ssk/intel_mark2/class02/smart-factory/open_model_zoo')
...
def build_argparser():
    ...
    args.add_argument("-ardu", "--device_ardu", default=None, type=str, help="Arduino port")
